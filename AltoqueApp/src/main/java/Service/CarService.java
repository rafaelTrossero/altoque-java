...
public class CarService implements Serializable {
    ...
    public void update(Car car) {
        ...
        allCars.add(car);
        carFacadeLocal.edit(car);
    }
    
     public void cargarCar() {
        try {
            this.setAllCars(this.carFacadeLocal.findAll());
    ...
    public List<Car> findByPatente(String criterioBusqueda) {
       return carFacadeLocal.findByPatente(criterioBusqueda);
    }

    public List<Car> findByMarca(String criterioBusqueda) {
       return carFacadeLocal.findByMarca(criterioBusqueda);
    }

    public List<Car> findByModelo(String criterioBusqueda) {
        return carFacadeLocal.findByModelo(criterioBusqueda);
    }
    public List<Car> findAll() {
        return carFacadeLocal.findAll();
    }
}